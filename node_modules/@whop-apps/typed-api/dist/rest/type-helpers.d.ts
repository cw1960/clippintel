...
export type MakeObjectsWithoutRequiredKeysOptional<T> = Partial<Pick<T, KeysWhereObjectsAreOptional<T>>> & Omit<T, KeysWhereObjectsAreOptional<T>>;
...
export type ResponseObjectMap<T> = T extends {
    responses: any;
} ? T["responses"] : unknown;
...
export type OperationRequestBody<T> = T extends {
    requestBody?: any;
} ? T["requestBody"] : never;
...
export type OperationRequestBodyContent<T> = FilterKeys<OperationRequestBodyMediaContent<T>, MediaType> extends never ? FilterKeys<NonNullable<OperationRequestBodyMediaContent<T>>, MediaType> | undefined : FilterKeys<OperationRequestBodyMediaContent<T>, MediaType>;
