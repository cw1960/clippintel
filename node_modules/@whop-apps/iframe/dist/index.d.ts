export { appsServerSchema } from "./apps-server";
export { whopServerSchema } from "./whop-server";
import { type ServerImplementation } from "@whop-apps/typed-transport";
import type { z } from "zod";
import { appsServerSchema } from "./apps-server";
import { whopServerSchema } from "./whop-server";
/**
 * Create an iframe SDK for a client app. This will communicate with the parent
 * window which is required to be whop.com.
 */
export declare function createAppIframeSDK({ onMessage, appId, overrideParentOrigins, }: {
    onMessage?: ServerImplementation<typeof appsServerSchema, false>;
    appId?: string;
    overrideParentOrigins?: string[];
}): import("@whop-apps/typed-transport").ClientSDK<z.ZodDiscriminatedUnion<"event", [z.ZodObject<{
 ...
 */
export declare function createWhopIframeSDK({ appId, onMessage, remoteWindow, remoteOrigin, }: {
    appId: string;
    remoteWindow: Window;
    remoteOrigin: string;
