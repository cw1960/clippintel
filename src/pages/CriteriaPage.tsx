...
export const CriteriaPage: React.FC = () => {
  ...
  useEffect(() => {
    if (activeItem !== "criteria") setActiveItem("criteria");
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                ...
                >
                  <Stack gap="md">
                    ...
                    <Text c="dimmed">
                      Create, edit, and organize your opportunity matching
                      criteria
                    </Text>
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                ...
                >
                  <Stack gap="md">
                    ...
                    <Text c="dimmed">
                      Use pre-built templates to quickly set up common criteria
                      patterns
                    </Text>
                    <Button variant="light" fullWidth>
                      Browse Templates
                  ...
                  <Group gap="md">
                    <Stack gap={0}>
                      ...
                      <Text size="sm" c="dimmed">
                        {criteria.matches} matches this week
                      </Text>
                    </Stack>
                  </Group>
                  <Group gap="sm">
