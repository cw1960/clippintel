        ...
        <Grid>
            ...
            <Paper p="md" radius="md" style={{ border: '1px solid var(--mantine-color-default-border)' }}>
              <Stack gap="xs">
                <Group justify="space-between">
                  <Text size="sm" c="dimmed" fw={500}>Active Opportunities</Text>
          ...
          <Grid.Col span={{ base: 12, md: 3 }}>
            <Paper p="md" radius="md" style={{ border: '1px solid var(--mantine-color-default-border)' }}>
              <Stack gap="xs">
                <Group justify="space-between">
                  <Text size="sm" c="dimmed" fw={500}>Match Score</Text>
          ...
          <Grid.Col span={{ base: 12, md: 3 }}>
            <Paper p="md" radius="md" style={{ border: '1px solid var(--mantine-color-default-border)' }}>
              <Stack gap="xs">
                <Group justify="space-between">
                  <Text size="sm" c="dimmed" fw={500}>Applications</Text>
                  <IconCalendarEvent size={16} color="var(--mantine-color-orange-6)" />
                </Group>
                <Text size="xl" fw={700} c="orange">8</Text>
                <Text size="xs" c="orange">3 pending review</Text>
              </Stack>
            </Paper>
          </Grid.Col>
          <Grid.Col span={{ base: 12, md: 3 }}>
            <Paper p="md" radius="md" style={{ border: '1px solid var(--mantine-color-default-border)' }}>
              <Stack gap="xs">
                ...
                <Text size="xl" fw={700} c="purple">72%</Text>
                <Text size="xs" c="purple">Above average</Text>
              </Stack>
            </Paper>
          </Grid.Col>
        </Grid>
          ...
          <Grid.Col span={{ base: 12, lg: 8 }}>
            <Paper p="xl" radius="md" style={{ border: '1px solid var(--mantine-color-default-border)' }}>
              <Stack gap="md">
                ...
                <Stack gap="md">
                  {[
                    { title: 'AI Research Innovation Grant', value: '$150,000', match: 95, deadline: '15 days', status: 'new' },
                    { title: 'Small Business Technology Fund', value: '$75,000', match: 88, deadline: '8 days', status: 'reviewing' },
                    { title: 'Digital Transformation Initiative', value: '$200,000', match: 82, deadline: '22 days', status: 'new' },
                    { title: 'Sustainability Research Program', value: '$100,000', match: 79, deadline: '5 days', status: 'applied' },
                  ].map((opportunity, index) => (
                    <Paper key={index} p="md" radius="sm" style={{ 
                      ...
                      <Group justify="space-between" align="flex-start">
                        <Stack gap="xs" style={{ flex: 1 }}>
                          <Group gap="sm">
                            <Text fw={500} size="sm">{opportunity.title}</Text>
                            <Badge 
                              color={opportunity.status === 'new' ? 'blue' : opportunity.status === 'applied' ? 'green' : 'orange'}
                              variant="light"
                              size="xs"
                            >
                              {opportunity.status}
                          ...
                          <Group gap="lg">
                            <Text size="xs" c="dimmed">Value: {opportunity.value}</Text>
                            <Text size="xs" c="dimmed">Deadline: {opportunity.deadline}</Text>
                          </Group>
                          <Group gap="sm" align="center">
                            ...
                            <Progress 
                              ...
                              color={opportunity.match > 90 ? 'green' : opportunity.match > 80 ? 'blue' : 'orange'}
                            />
                            <Text size="xs" fw={500} c={opportunity.match > 90 ? 'green' : opportunity.match > 80 ? 'blue' : 'orange'}>
                              {opportunity.match}%
                            </Text>
                          </Group>
                        </Stack>
          ...
          <Grid.Col span={{ base: 12, lg: 4 }}>
            <Paper p="xl" radius="md" style={{ border: '1px solid var(--mantine-color-default-border)' }}>
              <Stack gap="md">
                ...
                <Stack gap="sm">
                  <Button fullWidth variant="light" leftSection={<IconTargetArrow size={16} />}>
                    Create New Criteria
                  </Button>
